...
//go:generate curl 127.0.0.1:8000
...
//go:generate curl 127.0.0.1:8000/hello
...
//go:generate curl -X PUT 127.0.0.1:8000/hello
func (c *Default) PutHello() freedom.Result {
	return &infra.JSONResponse{Object: "putHello"}
}

// PostHello handles the POST: /hello route.
//go:generate curl -X POST 127.0.0.1:8000/hello -d '{"userName":"Jack","userPassword":"123456"}'
...
// BeforeActivation .
//go:generate curl 127.0.0.1:8000/custom
...
//go:generate  curl 127.0.0.1:8000/user/lucy?token=abc&id=1001
...
//go:generate curl 127.0.0.1:8000/age/18/user/Jack
